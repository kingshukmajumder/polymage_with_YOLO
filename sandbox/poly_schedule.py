...
def match_sig_ifft2(reduce_expr, lhs_params, lhs_constant):
...
def is_object_matrix(obj):
    if not isinstance(obj, (Reduction, Wave)) and \
...
def rect_tile(pipeline, group, group_parts):
    global _group_id
    comp_dim = 0
    tile_dims = 0
    no_tile_dims = 0
