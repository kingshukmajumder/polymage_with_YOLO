...
from polymage_flatten import polymage_flatten
...
def build_flatten(app_data):
    pipe_data = app_data['pipe_data']

    out_flatten = polymage_flatten(pipe_data)
    
    live_outs = [out_flatten]
    ...
    p_estimates = [(C, app_data['C']), (Y, app_data['Y']), (X, app_data['X']), (N, app_data['N'])]
