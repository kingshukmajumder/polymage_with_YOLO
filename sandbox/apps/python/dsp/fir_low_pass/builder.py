...
from polymage_fir_low_pass import fir_low_pass
...
def build_fir_low_pass(app_data):
    pipe_data = app_data['pipe_data']

    out_fir_low_pass, oflp2 = fir_low_pass(pipe_data)
    
    N = pipe_data['N']
    F = pipe_data['F']
    typ = pipe_data['typ']

    live_outs = [out_fir_low_pass, oflp2]
