...
class TStencil(Function):
    def __init__(self, _var_domain, _typ, _name, _timesteps=1, _bounds=None):
        Function.__init__(self, _var_domain, _typ, _name)
    ...
    def __str__(self):
        size = get_valid_kernel_sizes(self._stencil._kernel)
